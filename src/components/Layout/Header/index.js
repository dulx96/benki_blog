...
class Header extends React.PureComponent {
  ...
  toggleCateMenu = () => {
    this.setState(prevState =>
      this.setState({ cateMenuOpen: !prevState.cateMenuOpen })
    )
  }
          ...
          <div className="container">
            <div className="navbar-brand d-flex justify-content-between w-100 align-items-center">
              ...
              <div className="collapse navbar-collapse" id="navbarContent">
                <ul className="navbar-nav ml-auto">{lv1Category}</ul>
              </div>
              <div className="navbar-toggler px-0">
                ...
                {this.state.cateMenuOpen && (
                  <Modal
                    category={lv1Category}
                    active={this.state.cateMenuOpen}
          ...
          <div className="modal-dialog mt-5" role="document">
            <div className="modal-content">
              <div className="p-0 modal-body">
                <div>
                  <ul className="navbar-nav ml-auto">{this.props.category}</ul>
                </div>
              </div>
            </div>
          </div>
