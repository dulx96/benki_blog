      ...
      <Layout isHomePage={true}>
        <section className='container-fluid hero__main'>
          <div className='container'>
            <div
              className='row align-content-center text-center justify-content-center hero__main-content'>
              <div
                className='hero__main-content-items col-sm-8 col-md-9 col-lg-7 col-xl-6 mx-auto'>
                <h3 className='text-center'>
                  Blog chia sẻ kiến thức tiếng Nhật
                </h3>
                <h1>
                  Học tiếng Nhật online qua video song ngữ
                </h1>
                <div>
                  <span>
                    <a href='https://benkitv.com'
                       className="btn btn-secondary btn__play-video mr-2">

                      <img
                        src={playIcon}
                        className="icon-play-triangle mr-2 mb-1" alt="play"/>
                        Xem ngay
                    </a>
                  </span>
                  <a
                    className="btn btn-primary"
                    href="https://benkitv.com/about">Giới thiệu</a>
                </div>
              </div>
        ...
        <section
          className='container-fluid grey-bg hero__kits-overview-section'>
          <div className='container'>
        ...
        <section
          className='container post__list'>
          <div
            className='row news__content'>
            <div
              className='col-sm-12 col-md-10 col-lg-8 col-xl-8 mx-auto px-0'>
              {postCards}
            </div>
          </div>
